 ...
 * 
 * Gọi Pi Platform API để hoàn tất giao dịch thanh toán
 * 
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Gọi Pi Platform API endpoint complete
    const piApiUrl = `https://api.minepi.com/v2/payments/${paymentId}/complete`;
    
    console.log("[v0] Calling Pi Platform API:", piApiUrl, "with txid:", txid);
